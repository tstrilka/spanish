package app.spanish.translation
...
class TranslationService @Inject constructor() {
    ...
    suspend fun initializeTranslators() {
        if (!isInitialized) {
            try {
                ...
                isInitialized = true
                app.spanish.util.Logger.i("Translation models downloaded")
            } catch (e: Exception) {
                app.spanish.util.Logger.e("Failed to download translation models", e)
            }
        }
    }
    ...
    suspend fun translate(text: String, isSpanishToCzech: Boolean = false): String {
        ...
        return try {
            ...
            app.spanish.util.Logger.e("Translation failed", e)
