...
class SpeechRecognitionManager @Inject constructor(
    ...
    private fun initializeSpeechRecognizer() {
        try {
            ...
            if (!isSpeechRecognitionAvailable()) {
                ...
                app.espanol.util.Logger.e("Speech recognition not available")
                return
            }
            ...
            if (speechRecognizer == null) {
                ...
                app.espanol.util.Logger.e("Speech recognition service not available")
            }
        } catch (e: Exception) {
            _error.value = "Failed to initialize speech recognition: ${e.message}"
            app.espanol.util.Logger.e("Speech recognition initialization failed", e)
        }
    }
    ...
    fun startListening() {
        try {
            ...
            if (!hasAudioPermission()) {
                ...
                app.espanol.util.Logger.e("Audio permission not granted")
                return
            }
            ...
            speechRecognizer?.setRecognitionListener(object : RecognitionListener {
                override fun onReadyForSpeech(params: Bundle?) {
                    app.espanol.util.Logger.i("Speech recognition ready for Spanish")
                }

                override fun onBeginningOfSpeech() {
                    app.espanol.util.Logger.i("Spanish speech recognition started")
                }
                ...
                override fun onEndOfSpeech() {
                    app.espanol.util.Logger.i("Spanish speech recognition ended")
                ...
                override fun onError(error: Int) {
                    ...
                    app.espanol.util.Logger.e("Spanish speech recognition error: $errorMessage (code: $error)")
                ...
                override fun onResults(results: Bundle?) {
                    ...
                    if (matches != null && matches.isNotEmpty()) {
                        ...
                        _error.value = null
                        app.espanol.util.Logger.i("Spanish speech recognized: $bestMatch")

                        // Log all alternatives for debugging
                        matches.forEachIndexed { index, match ->
                            app.espanol.util.Logger.d("Spanish alternative $index: $match")
                        }
                    } else {
                        _error.value = "No Spanish speech recognized"
                        app.espanol.util.Logger.w("No Spanish speech matches found")
                    }
                }
                ...
                override fun onPartialResults(partialResults: Bundle?) {
                    ...
                    if (matches != null && matches.isNotEmpty()) {
                        app.espanol.util.Logger.d("Partial Spanish result: ${matches[0]}")
                    }
                }
            ...
            app.espanol.util.Logger.e("Spanish speech recognition start failed", e)
        }
    }
    ...
    private fun reinitializeAfterError() {
        try {
            ...
            app.espanol.util.Logger.e("Failed to reinitialize speech recognition", e)
        }
    }
    ...
    fun stopListening() {
        try {
            ...
            app.espanol.util.Logger.e("Failed to stop speech recognition", e)
        }
    }
    ...
    fun destroy() {
        try {
            ...
            app.espanol.util.Logger.e("Failed to destroy speech recognition", e)
        }
    }
    ...
    private fun checkAvailableLanguages() {
        try {
            ...
            app.espanol.util.Logger.d("Checking available languages...")
            ...
            if (activities.isNotEmpty()) {
                app.espanol.util.Logger.d("Spanish language support detected")
            } else {
                app.espanol.util.Logger.w("No Spanish language support found")
            }

        } catch (e: Exception) {
            app.espanol.util.Logger.e("Language check failed", e)
        }
    }
}